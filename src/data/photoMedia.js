...
export const photoMedia = {
  'hiking-bavaria': { image: bavariaImg.src, webp: bavariaImg.webp, place: 'Herzogstand · ’26' },
  'munich-landmarks': { image: munichImg.src, webp: munichImg.webp, place: 'München' }
};

export const fallbackMedia = { image: leafImg.src, webp: leafImg.webp, place: '' };
